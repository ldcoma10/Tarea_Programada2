...
public class AccMalas extends JFrame {
	...
	public AccMalas(final JFrame frame,List <nino> lista,String accion) {
		int x= lista.size();
		String cadena="";
		...
		lblNewLabel_1.setIcon(new ImageIcon("/home/ldcoma10/workspace1/Diego/src/malasacciones.gif"));
